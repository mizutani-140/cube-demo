...
export const businesses = [
  ...
  },
  {
    ...
    color: '#8B5A2B',
    icon: 'ABOUT',
    image: '/About_CUBE_upscaled.webp',
    isExternal: false,
  },
  {
    id: 'access',
  ...
  },
  {
    ...
    color: '#2E8B57',
    icon: 'ART',
    image: '/LIFE NOSTALGIA_upscaled.webp',
    isExternal: false,
    isComingSoon: true,
  },
];
